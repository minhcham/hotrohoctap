            ...
            <div class="m-login__container">
                ...
                <div class="m-login__signin">
                    <div class="m-login__head">
                        <h3 class="m-login__title">Hệ thống hỗ trợ học tập</h3>
                    </div>
                ...
                <div class="m-login__signup">
                    ...
                    <form class="m-login__form m-form" action="">
                        @csrf
                        <div class="form-group m-form__group">
                            <input class="form-control m-inpuAuth\t" type="text" placeholder="Tên đầy đủ" name="fullname">
                        </div>
                        <div class="form-group m-form__group">
                            <input class="form-control m-input" type="text" placeholder="Email" name="email" autocomplete="off">
                        </div>
                        ...
                        <div class="form-group m-form__group">
                            <input class="form-control m-input m-login__form-input--last" type="password" placeholder="Nhập lại mật khẩu" name="rpassword">
                        </div>
                        ...
                        <div class="m-login__form-action">
                            <button id="m_login_signup_submit" class="btn btn-focus m-btn m-btn--pill m-btn--custom m-btn--air  m-login__btn">Đăng ký</button>&nbsp;&nbsp;
